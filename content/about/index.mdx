...
title: About
order: 4
descriptionEn: I am currently working for [Normally](https://www.normally.com) as Lead Interaction Designer. I also volunteer at Repair Cafe Nunhead as an appliances repairer.
descriptionJa: 現在は、[Normally](https://www.normally.com) で Lead Interaction Designer として働く傍ら、Repair Cafe Nunhead でボランティア修理工としても活動している。
---

import BilingualSection from "@/components/bilingual-section";
import MonolingualSection from "@/components/monolingual-section";
...
<BilingualSection>
Yosuke Ushigome (yō-ské • he/him) is a London-based designer / technologist, currently working for [Normally](https://www.normally.com) as Lead Interaction Designer, [UAL Creative Computing Institute](https://www.arts.ac.uk/creative-computing-institute) as Associate Lecturer, and [Repair Cafe Nunhead](https://www.instagram.com/repaircafe_nunhead/) as volunteer repairer.

牛込 陽介。ロンドンを拠点に活動するデザイナー／テクノロジスト。現在、[Normally](https://www.normally.com) で Lead Interaction Designer、[UAL Creative Computing Institute](https://www.arts.ac.uk/creative-computing-institute) で Associate Lecturer、[Repair Cafe Nunhead](https://www.instagram.com/repaircafe_nunhead/) でボランティア修理工として働く。

</BilingualSection>

<BilingualSection>
He uses design, prototyping, and repair to facilitate the imagination and
discussion about more just and sustainable ways we could interact with
technologies. Recent projects include research and visualisation of the
diverse nature of transitions towards sustainable futures for Hitachi, and
developing a more cultural and spiritual interaction with AI voice assistants
with Swarovski.

デザイン、プロトタイピング、リペアをとおして、テクノロジーとのより公正でサステナブルな関わりについての想像と議論を後押しすることを活動の中心としている。最近のプロジェクトには、日立製作所と行ったサステナブルな未来へのトランジションの多元性のリサーチとその視覚化、スワロフスキーと共同で開発した AI 音声アシスタントとのより文化的なインタラクションのプロトタイプなどがある。

</BilingualSection>

<BilingualSection>
He also writes and talks about the roles of design and technology in the age of crises. Like this article about the societal implications of seemingly small design decisions, and alternative interactions with technology for the transition towards sustainable and just worlds we want.

また、危機の時代におけるデザインとテクノロジーの役割について執筆したり講演したりもする。例えば、一見小さなデザインの決定が社会に与える影響や、私たちが望む持続可能で公正な世界への移行のためのテクノロジーとの代替的な相互作用についてのこの記事。
