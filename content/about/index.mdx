...
import MonolingualSection from "@/components/monolingualSection";
...
<BilingualSection>
  Yosuke Ushigome (yō-ské • he/him) is a London-based designer. He
  currently works for [Normally](https://www.normally.com) as Lead Interaction
  Designer, [UAL Creative Computing
  Institute](https://www.arts.ac.uk/creative-computing-institute) as Associate
  Lecturer, and [Repair Cafe
  Nunhead](https://www.instagram.com/repaircafe_nunhead/) as volunteer repairer.

牛込 陽介。ロンドンを拠点に活動するデザイナー。現在、[Normally](https://www.normally.com) で Lead Interaction Designer、[UAL Creative Computing Institute](https://www.arts.ac.uk/creative-computing-institute) で Associate Lecturer、[Repair Cafe Nunhead](https://www.instagram.com/repaircafe_nunhead/) でボランティア修理工として働く。
...
<BilingualSection>
  He also write and talk about the roles of design and technology in the age of
  crises. Like this article about the societal implications of seemingly small
  design decisions, and alternative interactions with technology for the
  transition towards sustainable and just worlds we want.
